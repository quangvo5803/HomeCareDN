...
export default function Sidebar({
  ...
  const menu = useMemo(
    () => [
      {
        key: "dashboard",
        label: t("contractordashboard.dashboard"),
        icon: <i class="fa-solid fa-house"></i>,
        to: "/contractor",
      },
      {
        key: "service_requests",
        label: t("contractordashboard.service_requests"),
      ...
      {
        key: "applications",
        label: t("contractordashboard.my_applications"),
        icon: <i class="fa-solid fa-calendar-check"></i>,
        to: "/applications",
      },
      {
        key: "payments",
        label: t("contractordashboard.commission_payments"),
        icon: <i class="fa-solid fa-money-bill"></i>,
        to: "/payments",
      },
      {
        key: "reviews",
        label: t("contractordashboard.reviews"),
        icon: <i class="fa-solid fa-star"></i>,
        to: "/reviews",
      },
      {
        key: "profile",
        label: t("contractordashboard.profile_management"),
