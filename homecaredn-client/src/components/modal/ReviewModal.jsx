...
export default function ReviewModal({
  ...
  // Fill data when viewing existing review
  useEffect(() => {
    if (isOpen) {
      if (review) {
        ...
        <div className="flex-1 pr-2 mt-6 space-y-6 overflow-y-auto">
          ...
          <div>
            ...
            {!readOnly && images.length < 5 && (
              <div className="mt-3">
                <label className="inline-block px-4 py-2 border-2 border-gray-300 border-dashed cursor-pointer rounded-xl hover:border-blue-400 hover:bg-blue-50">
