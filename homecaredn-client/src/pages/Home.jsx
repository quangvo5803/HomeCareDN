...
const heroData = {
  ...
  image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749277173/carousel-1_cusbvg.jpg',
};
...
const aboutUsData = {
  ...
  image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749285221/about_upkv2j.jpg',
};
const processItems = [
  {
    number: '01',
    title: 'Construction',
    description: 'Aliqu diam diam et eos erat ipsum lorem stet clita duo justo erat amet',
    image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749286666/fact-1_gdm2t1.jpg',
  },
  {
    number: '02',
    title: 'Mechanical',
    description: 'Aliqu diam diam et eos erat ipsum lorem stet clita duo justo erat amet',
    image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749286666/fact-2_fxjryy.jpg',
  },
  {
    number: '03',
    title: 'Architecture',
    description: 'Aliqu diam diam et eos erat ipsum lorem stet clita duo justo erat amet',
    image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749286667/fact-3_ag7tin.jpg',
  },
  {
    number: '04',
    title: 'Interior Design',
    description: 'Aliqu diam diam et eos erat ipsum lorem stet clita duo justo erat amet',
    image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749286666/fact-4_jhvrtl.jpg',
  },
];

const serviceItems = [
  {
    image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749355179/service-1_dswhst.jpg',
    title: 'Building Construction',
  },
  {
    image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749355179/service-2_tmscpu.jpg',
    title: 'Home Maintenance',
  },
  {
    image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749355179/service-3_sqc14e.jpg',
    title: 'Renovation and Painting',
  },
  {
    image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749355179/service-4_swwy8b.jpg',
    title: 'Wiring and Installation',
  },
  {
    image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749355179/service-5_hxqszr.jpg',
    title: 'Filling and Painting',
  },
  {
    image: 'https://res.cloudinary.com/dl4idg6ey/image/upload/v1749355179/service-6_lyqrs4.jpg',
    title: 'Interior Design',
  },
];
...
const renovationSolutionsData = {
  title: 'Construction And Renovation Solutions',
  solutions: serviceItems, // Tái sử dụng dữ liệu serviceItems ở trên
};
...
>
  ...
  <div className="relative text-center text-white p-6 z-10">
    ...
    <h1 className="text-4xl lg:text-6xl font-bold leading-tight mb-4">{heroData.title}</h1>
  ...
  <div className="container mx-auto max-w-screen-xl px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    <div className="flex-1 space-y-6">
      ...
      <div className="border-l-4 border-orange-500 pl-4">
        <h2 className="text-4xl font-bold leading-tight">{aboutUsData.title}</h2>
      </div>
      <p className="text-gray-600 leading-relaxed">{aboutUsData.description}</p>
      <p className="text-gray-600 leading-relaxed">{aboutUsData.description2}</p>
...
<div className="absolute inset-0 bg-black/50 group-hover:bg-black/60 transition-colors duration-300" />
        ...
        <div className="absolute inset-0 flex flex-col items-start justify-end p-8 text-white">
          <p className="text-7xl font-bold text-orange-500 mb-4">{item.number}</p>
          <h3 className="text-2xl font-bold mb-2">{item.title}</h3>
          <p className="text-sm mb-4 leading-relaxed max-w-xs">{item.description}</p>
          <a href="#" className="flex items-center text-sm font-medium text-white hover:text-orange-500 transition-colors duration-300">
      ...
      <section className="bg-gray-50 py-16 lg:py-24">
        <div className="container mx-auto max-w-screen-xl px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Construction & Renovation Solutions</h2>
        ...
        <div className="container mx-auto max-w-screen-xl px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex-1 space-y-6">
            <div className="relative inline-block px-4 py-2 bg-orange-500 text-white font-bold rounded-lg transform -rotate-1">
              <span className="relative z-10">{companyFeaturesData.yearsOfExperience}</span>
            </div>
            <h2 className="text-4xl font-bold leading-tight">{companyFeaturesData.title}</h2>
          ...
          <div className="flex-1 relative rounded-lg overflow-hidden shadow-lg">
            <img src={companyFeaturesData.image} alt="Company Features" className="w-full h-auto object-cover" />
          </div>
        </div>
      </section>
    </div>
