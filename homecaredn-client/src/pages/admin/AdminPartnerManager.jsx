      ...
      <div className="w-full max-w-full mx-auto">
        ...
        <div className="mb-8">
          <h2 className="mb-2 text-2xl font-bold text-gray-800 lg:text-3xl">
            <i className="mr-3 fa-solid fa-handshake"></i>
          ...
          <div className="hidden lg:block">
            <table className="w-full">
              ...
              <tr className="border-b border-gray-200 bg-gray-50">
                <th className="px-4 py-4 text-xs font-semibold text-center uppercase text-gray-600">#</th>
                <th className="px-6 py-4 text-xs font-semibold text-center uppercase text-gray-600">{t('partner.full_name', 'Full name')}</th>
                <th className="px-6 py-4 text-xs font-semibold text-center uppercase text-gray-600">{t('partner.company_name', 'Company')}</th>
                <th className="px-6 py-4 text-xs font-semibold text-center uppercase text-gray-600">Email</th>
                <th className="px-6 py-4 text-xs font-semibold text-center uppercase text-gray-600">{t('partner.phone_number', 'Phone')}</th>
                <th className="px-6 py-4 text-xs font-semibold text-center uppercase text-gray-600">{t('partner.type', 'Type')}</th>
                <th className="px-6 py-4 text-xs font-semibold text-center uppercase text-gray-600">{t('common.status', 'Status')}</th>
                <th className="px-4 py-4 text-xs font-semibold text-center uppercase text-gray-600">{t('adminServiceManager.action', 'Action')}</th>
              </tr>
              </thead>
...
function StatusBadge({ status }) {
  ...
  return (
    <span className={`inline-flex px-2.5 py-1 rounded-full text-xs border ${map[status] || 'bg-gray-100 text-gray-800 border-gray-300'}`}>
      {status}
    </span>
  );
}
