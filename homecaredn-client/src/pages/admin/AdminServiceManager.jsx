            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm font-medium">
                  {t('adminServiceManager.subtitle')}
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="px-5 py-3 bg-orange-500 rounded-xl shadow-lg">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                    <i className="fa-solid fa-gear text-white text-lg" />
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-white">
                      {loading ? 0 : totalServices || 0}
                    </div>
                    <div className="text-xs text-white/90 font-medium">
                      {t('adminServiceManager.services')}
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        <td colSpan="5" className="px-6 py-16 text-center">
                          <div className="flex flex-col items-center text-center mt-5 mb-5">
                            <div className="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mb-4">
                              <i className="fa-solid fa-gear text-gray-400 text-3xl" />
                            </div>
