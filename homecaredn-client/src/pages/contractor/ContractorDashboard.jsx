...
export default function ContractorDashboard() {
  ...
  const fetchKpi = useCallback(async () => {
    ...
    setKpiError(null);
    try {
      const data = await contractorApplicationService.getKpiData();
      setKpiData({
  ...
  }, [isContractor, currentPage, fetchKpi, fetchServiceRequests]);
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <button
                          onClick={() =>
                            navigate(
                              `/Contractor/service-request/${req.serviceRequestID}`
                            )
                          }
