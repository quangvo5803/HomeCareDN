    ...
    useRealtime({
        [RealtimeEvents.MaterialRequestCreated]: (payload) => {
            setMaterialRequests((prev) => {
                if (prev.some((r) => r.materialRequestID === payload.materialRequestID)) {
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">{t('distributorMaterialRequest.subtitle')}</p>
                    </div>
                </div>
                                    ...
                                    >
                                        ...
                                        <div className="flex justify-between items-center border-t border-gray-100 pt-4 px-4">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                >
                                                    <i className={`fa-solid ${req.canEditQuantity ? "fa-check" : "fa-xmark"}`} />
                                                    {req.canEditQuantity ? t('distributorMaterialRequest.canEditQuantity') : t('distributorMaterialRequest.noEditQuantity')}
                                                </span>
                                                ...
                                                >
                                                    <i className={`fa-solid ${req.canAddMaterial ? "fa-check" : "fa-xmark"}`} />
                                                    {req.canAddMaterial ? t('distributorMaterialRequest.canAddMaterial') : t('distributorMaterialRequest.noAddMaterial')}
                                                </span>
                                            </div>
