...
export default function MaterialRequestDetail() {
  ...
  const { getMaterialRequestById, loading, setMaterialRequests } =
    useMaterialRequest();
  ...
  useRealtime({
    ...
    [RealtimeEvents.DistributorApplicationRejected]: () => {
      setExistingApplication((prev) => ({ ...prev, status: 'Rejected' }));
    },
    [RealtimeEvents.MaterialRequestDelete]: (payload) => {
      if (payload.materialRequestID === materialRequestId) {
        navigate('/Distributor/MaterialRequestManager');
  ...
  const materialRequestDetail = useCallback(async () => {
    try {
      ...
      const applied =
        await distributorApplicationService.getByMaterialRequestIdForContractor(
          {
  ...
  useEffect(() => {
    if (materialRequestId && user?.id) materialRequestDetail();
  ...
  const handleDeleteMaterial = (materialRequestItemID) => {
    setNewMaterials((prev) =>
      prev.filter(
        (item) => item.materialRequestItemID !== materialRequestItemID
      )
    );
  };
        ...
        {(() => {
          ...
          return (
            <div className="space-y-2">
              ...
              {estimatePrice > 2_000_000_000 && commission >= 100_000_000 && (
        ...
        <div>
          ...
          {canAddMaterial && (
            <label className="flex items-center text-sm font-medium text-gray-700 mb-4">
              ...
              {t('distributorMaterialRequestDetail.additionalSupplies')} (
          ...
          {hasNewMaterials ? (
            ...
            <>
              {newMaterials.length > 0 && canAddMaterial && (
                <>
                  {/* Table Header for New Materials */}
                    ...
                    >
                      ...
                      <div className="hidden lg:grid lg:grid-cols-28 gap-4 items-center">
                        ...
                        <div className="col-span-5">
                          <h3 className="font-bold text-center text-slate-900 mb-3 line-clamp-2 text-sm">
                            {displayName}
                          </h3>
                        ...
                        <div className="col-span-4 flex justify-center">
                          <input
                            ...
                            min={0}
                            value={item.price || ''}
                            className="w-25 px-3 py-2 border-2 border-slate-200 rounded-lg text-center focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all font-bold text-slate-900 text-sm"
                            placeholder="0"
                            onChange={(e) =>
            ...
            return (
              ...
              >
                <div className="hidden lg:grid lg:grid-cols-18 gap-4 items-center text-center">
                  ...
                  <div className="col-span-3 flex justify-center">
                    <div className="flex items-center gap-2">
                      <div className="w-13 px-2 py-2 border-2 border-slate-200 rounded-lg text-center font-bold text-slate-900 text-sm disabled:bg-slate-50">
                        {item.quantity}
                      </div>
                    </div>
                  </div>
      ...
      {existingApplication?.message && (
        <div className="border-t pt-6">
          ...
          <div
            ...
            dangerouslySetInnerHTML={{ __html: existingApplication?.message }}
          />
        </div>
      )}
        ...
        <div className="lg:col-span-9 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-300 p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
              ...
              {materialRequest?.materialRequestItems?.length || 0})
            </h3>
                      ...
                      <div className="hidden lg:grid lg:grid-cols-24 gap-3 items-center text-center">
                        ...
                        <div className="col-span-3 flex justify-center">
                          <input
                            ...
                            className="w-20 px-2 py-2 border-2 border-slate-200 rounded-lg text-center font-bold text-slate-900 text-sm disabled:bg-slate-50"
                          />
                        </div>
                        ...
                        <div className="col-span-4 flex justify-center">
                          <input
                            ...
                            className="w-full px-3 py-2 border-2 border-slate-200 rounded-lg text-center font-bold text-slate-900 text-sm bg-white focus:border-orange-400 focus:ring-1 focus:ring-orange-400"
                            placeholder="0"
                          />
                        </div>
                  ...
                  {isRequestClosed ? (
                    <>
                      ...
                      <p className="text-sm font-semibold text-gray-700 mb-1">
                        {t(
                          'distributorMaterialRequestDetail.closedApplication'
                        )}
                      </p>
