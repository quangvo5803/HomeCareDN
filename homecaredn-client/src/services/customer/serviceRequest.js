...
export const serviceRequest = {
  getAllServiceRequestByUserId: async (params = {}) => {
    const res = await api.get(
      '/CustomerServiceRequest/get-all-service-request-by-user-id',
      {
        params,
      }
    );
  ...
  getServiceRequestById: async (id) => {
    const res = await api.get(
      `/CustomerServiceRequest/get-service-request-by-id/${id}`
    );
    return res.data;
  },
  createServiceRequest: async (data) => {
    ...
    const res = await api.post(
      '/CustomerServiceRequest/create-service-request',
      formData
    );
    return res.data;
  },
  ...
  updateServiceRequest: async (data) => {
    ...
    const res = await api.put(
      '/CustomerServiceRequest/update-service-request',
      formData
    );
    return res.data;
  },
  ...
  deleteServiceRequest: async (id) => {
    const res = await api.delete(
      `/CustomerServiceRequest/delete-service-request/${id}`
    );
    return res.data;
  },
};
